...
<form action="" method="POST">
    ...
    <?php if (isset($_GET['success'])): ?>
        <div style="background:#eafff0; color:#108043; padding:15px 20px; border-radius:6px; margin-bottom:20px; border:1px solid #33d067; font-weight:500; display:flex; justify-content:space-between;">
            <span>✅ Thêm mới danh mục thành công</span>
        </div>
    <?php elseif (isset($_GET['updated'])): ?>
        <div style="background:#eafff0; color:#108043; padding:15px 20px; border-radius:6px; margin-bottom:20px; border:1px solid #33d067; font-weight:500;">
    ...
    <div class="sapo-grid">
        <div class="sapo-col-left">
            <div class="sapo-card">
                ...
                <div>
                    <label>Mô tả</label>
                    <textarea name="description" class="form-control" rows="5"><?php echo htmlspecialchars($category['description'] ?? ''); ?></textarea>
                </div>
            </div>
            <div class="sapo-card">
        ...
        <div class="sapo-col-right">
            <div class="sapo-card">
                ...
                <div class="radio-group"><input type="radio" name="status" value="Hiển thị" <?php echo (isset($category['status']) && $category['status'] == 'Hiển thị') ? 'checked' : ''; ?>> Hiển thị</div>
                <div class="radio-group"><input type="radio" name="status" value="Ẩn" <?php echo (isset($category['status']) && $category['status'] == 'Ẩn') ? 'checked' : ''; ?>> Ẩn</div>
            </div>
        </div>
    </div>
</form>
