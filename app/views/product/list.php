...
<style>
    /* CSS Khung bảng và Bộ lọc chuẩn */
    .sapo-filter-bar {
        display: flex;
        gap: 10px;
        padding: 15px;
    ...
    /* Dropdown CSS (Menu Chọn thao tác & Thêm sản phẩm) */
    .sapo-dropdown {
        position: relative;
                    ...
                    <th colspan="7" style="color: #212b36; font-weight: normal; overflow: visible;">
                        ...
                        <div class="sapo-dropdown" style="margin-left: 20px;">
                            ...
                            <div class="sapo-dropdown-content">
                                ...
                                <a href="#" id="btn-delete" onclick="return confirm('Thao tác này sẽ xóa sản phẩm bạn đã chọn. Thao tác này không thể khôi phục. Bạn có chắc chắn muốn xóa?');" style="color: #ff4d4f;">🗑️ Xóa sản phẩm</a>
                            </div>
                        </div>
                    </th>
                </tr>
            ...
            <tbody>
                <?php foreach ($products as $row): ?>
                    <tr class="product-row">
                        ...
                        <td class="col-num" style="color: <?php echo (isset($row['ton_kho']) && $row['ton_kho'] > 0) ? '#108043' : '#212b36'; ?>;">
                        ...
                        <td class="col-text" style="color: #637381;"><?php echo date('d/m/Y'); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
<script>
    ...
    function updateActionBar() {
        ...
        if (checked.length > 0) {
            ...
            // Gán link xóa vào nút "Xóa sản phẩm" trong dropdown
