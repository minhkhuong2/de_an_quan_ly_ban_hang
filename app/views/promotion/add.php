...
<script>
    ...
    window.addEventListener('DOMContentLoaded', () => {
        ...
        if (mode === 'coupon') {
            ...
            // Hiện thẻ Giới hạn sử dụng vì đây là Mã KM
            ...
            document.getElementById('promo_code').removeAttribute('required');

            // ẨN thẻ Giới hạn sử dụng vì Chương trình tự động không cần giới hạn
