                ...
                <div id="ship_block_carrier">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" onchange="setCarrierFee(this.value)">
                            ...
                            <option value="30000">Giao Hàng Tiết Kiệm (Dự kiến: 30.000đ)</option>
                            <option value="35000">Giao Hàng Nhanh Express (Dự kiến: 35.000đ)</option>
                            <option value="25000">Viettel Post Standard (Dự kiến: 25.000đ)</option>
                        </select>
                    </div>
                </div>
    ...
    function calculateOrderTotals() {
        ...
        if (currentShippingMode === 'self') {
            ...
            if (payer === 'khach') {
                ...
                orderShippingFee = 0;
                document.getElementById('lbl_shipping_fee').innerText = formatMoney(0) + " (Shop tự chi)";
            }
        }
