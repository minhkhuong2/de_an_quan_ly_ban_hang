...
<form action="index.php?action=add_purchase" method="POST">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h2 style="font-size: 20px; color: #212b36;"><a href="index.php?action=purchase_list" style="text-decoration:none; color:#637381;">←</a> Tạo đơn nhập hàng</h2>
        <button type="submit" class="btn-save">Hoàn tất nhập hàng</button>
    </div>

    <div style="display: flex; gap: 20px;">
        <div style="flex: 0 0 70%;">
            <div class="sapo-card">
                <h3 style="font-size: 16px; margin-bottom: 10px;">Chi tiết sản phẩm nhập</h3>
                ...
                <table class="table-import" id="importTable">
                    ...
                    <tbody id="importBody">
                        <tr class="item-row">
                            ...
                            <td><input type="number" name="import_price[]" class="form-control price-input" value="0" min="0" required oninput="calcTotal()"></td>
                            <td class="row-total" style="font-weight: bold; padding-top: 15px;">0 ₫</td>
                ...
                <button type="button" onclick="addRow()" style="background: #e6f7ff; color: #0088ff; border: 1px dashed #0088ff; padding: 8px 15px; border-radius: 4px; margin-top: 15px; cursor: pointer; width: 100%;">+ Thêm dòng sản phẩm</button>
            </div>
        </div>
        ...
        <div style="flex: 1;">
            ...
            <div class="sapo-card">
                <h3 style="font-size: 16px; margin-bottom: 15px;">Thanh toán</h3>
                <div style="display: flex; justify-content: space-between; font-size: 18px; font-weight: bold; color: #0088ff;">
                    <span>Tổng tiền:</span>
